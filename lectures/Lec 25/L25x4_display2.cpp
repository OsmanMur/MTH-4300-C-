...
public:
    ...
    virtual void display() const; //virtual allows to use the proper dynamic binding which calls the correct display function
...
int main() {
    ...
    for(int i = 0; i < 3; ++i){
        my_users[i]->display(); // doesnt care uses default user display not the one in faculty/staff
    }
