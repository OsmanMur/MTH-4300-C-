...
public:																		////
	...
	int lives;                         										////
    int coins;																////
	GameCharacter(): name("Computer Opponent"), lives(3), coins(0) {}		//// //why is this here? because we want to give the computer opponent a name
...
int main () {
	...
	GameCharacter me("Osman");
	me.collect_coins(120);
	me.print_info();
