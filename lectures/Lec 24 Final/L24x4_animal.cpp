...
Dog::Dog(string n, string b): Animal(n, "Dog"), breed{b} {
}

// This display() function is entirely rewritten -- no call to Animal::display()
void Dog::display() const {
    cout << name << " the " << breed << " is wagging their tail.\n";
}
