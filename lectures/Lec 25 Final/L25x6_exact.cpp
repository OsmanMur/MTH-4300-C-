...
public:
    ...
    // it breaks the virtual inheritance.  Overriding functions have to have
    // exactly the same parameter types and const qualifiers; otherwise, they are considered
    // to be "different" functions. 
    //
    // WITHOUT the word override -- the program compiles and runs, but silently does
    // the wrong thing.  Try removing it.
    //
    // WITH the word override -- compilation error, which alerts us to the problem.
    //
