...
int main() {
    ...
    User two = x; // This is allowed!  You can assign an Employee to a User, but you lose the Employee attributes.
    two.display();
    
    Employee three = a; // This is NOT allowed!  You can assign a User to an Employee, but not the other way around.
