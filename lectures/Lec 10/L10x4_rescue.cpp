...
int main () {
    ...
    while (cin.fail()) {
        cin.clear();    // Repair cin's state... // If this line is commented yuo would create an infinite loop because it will never reach the okay state
        cin.ignore(INT_MAX, '\n');  // ...and dump out lingering characters //If this line is commented you would make the state okay but you wont be able to even input anyting before
