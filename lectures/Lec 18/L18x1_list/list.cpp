...
List& List::operator=(const List& rhs) {
    if (this == &rhs){ // & --> address getter // this. --> pointer to the left handside // compare if they are actually identical.

    }
    //
    // Currently, there is no self-copying check
    // What goes wrong? 
    //
...
List::List(const List& rhs){ //requires List:: since part of a class!
    num_entries = rhs.num_entries;
