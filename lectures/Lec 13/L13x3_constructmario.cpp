...
public:																		
	...
	void die(); // mutator NO CONST REQUIRED
...
GameCharacter:: GameCharacter (string x){
	name = x;
	lives = 3;
	coins = 0;
}
...
//ALTERNATIVE IMPLENTATION OF CONSTRUCTORS
// GameCharacter::GameCharacter() : name("computer Player"), lives(3), coins(0) {}

// GameCharacter::GameCharacter(string n) : name(n), lives(3), coins(0) {}
///////////////////////////////////////
