...
int main() {
	...
	y = x;
	cout << "Address of y is still: " << &y << endl;
	...
	cout << "Here is z: " << z;	// same as &(z[0])
	
	char ch_arr[] = {'W', 'O', 'R', 'D', '\0'}; // '\0' is a null character that doesnt get displayed but it tells the program that it is the end of the array.
